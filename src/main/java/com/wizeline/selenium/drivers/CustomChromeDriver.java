...
public class CustomChromeDriver extends ChromeDriver implements BaseWebDriver {
    ...
    public CustomChromeDriver(ChromeOptions chromeOptions) {
        super(chromeOptions);
        mainWindowHandler = BaseWebDriverUtil.getCurrentWindowHandler(this);
    }
    ...
    public boolean waitUntilElementClickable(By selector, long seconds) {
        return BaseWebDriverUtil.waitUntilElementClickable(this, selector, seconds);
    }
    ...
    public boolean waitUntilTextPresent(By selector, long seconds, String text) {
        return BaseWebDriverUtil.waitUntilTextPresent(this, selector, seconds, text);
    }
